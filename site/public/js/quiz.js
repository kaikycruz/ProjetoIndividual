...
var questions = [
   ...
   {
     numQuest: 4,
     pergunta: "Em qual arco o Luffy utiliza a técnica gear fourth pela primeira vez?",
     alternativaA: "Wano",
   ...
   {
     numQuest: 10,
     pergunta: "Quantas vezes Luffy foi derrotado por Kaido ate finalmente vencer",
...
function iniciar() {  
    ...
    <div class="cronometro" id="cronometro">
      <span id="minuto"> 00</span>:<span id="segundo">00</span>
        ...
        <span id="spanPergunta">${questions[i].numQuest}. ${questions[i].pergunta}</span>
    ...
    <div class="questoes">
        ...
        <div class ="resps">
            <input 
                ...
                value="${questions[i].alternativaA}" ${questions[i].alternativaA == respostasUser[i] ? "checked" : ""}
            ><label for="alternativaA${questions[i].numQuest}">${questions[i].alternativaA}</label>
            </div>
        </div>
        <div class="alternativas">
        <div class ="resps">
            <input 
                ...
                value="${questions[i].alternativaB}" ${questions[i].alternativaB == respostasUser[i] ? "checked" : ""}
            ><label for="alternativaB${questions[i].numQuest}">${questions[i].alternativaB}</label>
            </div>
        </div>
        <div class="alternativas">
        <div class ="resps">
            <input 
                ...
                value="${questions[i].alternativaC}" ${questions[i].alternativaC == respostasUser[i] ? "checked" : ""}
            ><label for="alternativaC${questions[i].numQuest}">${questions[i].alternativaC}</label>
            </div>
        </div>
        <div class="alternativas">
        <div class ="resps">
            <input 
                ...
                value="${questions[i].alternativaD}" ${questions[i].alternativaD == respostasUser[i] ? "checked" : ""}
            ><label for="alternativaD${questions[i].numQuest}">${questions[i].alternativaD}</label>
            </div>
        </div>
    </div>
    </div>
    ...
    ${i < questions.length - 1 ? '<button id="btnNext" onclick="proxima()">Proxima</button>' : '<button id="btnFinalizar" onclick="proxima()">Finalizar</button>'}
    </div>
